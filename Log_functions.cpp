...
//!
//! @param [out] pointer_begin Pointer to the begin of space to be hashed
//! @param [out] pointer_end   Pointer to the end of space to be hashed
//!
//! @return Function returns value of hash.
//-----------------------------------------------------------------------------------
long long int HashCounter (const void* pointer_begin, const void* pointer_end)
{
    assert (pointer_begin);
    assert (pointer_end);
    ...
    for (size_t i = 0; i < (char*) pointer_end -  (char*) pointer_begin; i++)
    {
        ...
        char temp_2 = byte_value >> NUM_BITS - 1;
...
//-----------------------------------------------------------------------------------
//! This function updates hash is structure Stack_t.
//!
//! @param [out] pointer Pointer to stack
//------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------
//! This function checks if the hash is incorrect.
//!
//! @param [out] pointer Pointer to stack
//--------------------------------------------------------------------------------------
